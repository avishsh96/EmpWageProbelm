...
interface IComputeEmpWage {
    ...
    void addCompanyEmpWage(String company, int empRatePerHour, int numOfWorkingDays, int maxHoursInMonth);
...
class Day23EmpWageComputation implements IComputeEmpWage {
...
//    private final int numOfCompany = 0;
    ...
    public int computeEmpWage(CompanyEmpWage companyEmpWage) {
        ...
        while (totalEmpHrs <= companyEmpWage.maxHoursPerMonth && totalWorkingDays < companyEmpWage.numOfWorkingDays) {
            ...
            Dictionary<Integer, String> geek = new Hashtable<>();
            String result;
